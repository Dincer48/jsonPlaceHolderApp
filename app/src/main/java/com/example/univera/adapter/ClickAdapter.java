...
public class ClickAdapter extends RecyclerView.Adapter<ClickAdapter.ViewHolder> implements Filterable {
    private ArrayList<User> userList;
    private ArrayList<User> filteredUserList;
    private Context context;
    private CustomItemClickListener customItemClickListener;

    public ClickAdapter(Context context,ArrayList<User> userArrayList,CustomItemClickListener customItemClickListener) {
    ...
    @Override
    public ClickAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(ClickAdapter.ViewHolder viewHolder, int position) {
